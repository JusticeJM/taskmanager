...
export default function EditForm(){
    const {editTask, editingTask,startEditing} = useTaskContext();

    const formik = useFormik({
        initialValues:{ 
            taskname: editingTask.taskname,
            status: editingTask.status||"incomplete",
            ...
            <div className="font-sans max-w-sm mx-auto bg-violet-50 my-18 border border-gray-200 rounded-lg pb-10 sm:max-w-md">
                <div className="px-4 pt-5">
                    <div className="flex justify-between items-center mb-4">
                        <span className="text-xl font-semibold">Edit a task</span>
                        <button onClick={() => startEditing(null)} className="p-1 bg-gray-200 rounded-lg cursor-pointer hover:bg-violet-300">
